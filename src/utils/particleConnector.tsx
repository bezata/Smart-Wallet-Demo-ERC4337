...
export default function ParticleAuth() {
  ...
  return (
    <div>
      {address ? (
        <button
          className="m-2 px-8 py-5 rounded-lg text-lg text-black bg-white font-bold border-l-gray-800 shadow-md shadow-black"
          onClick={() => disconnect()}
        >
          Disconnect
        </button>
        ...
        <button
          className="m-3 text-center px-6 py-4 rounded-lg text-lg text-black bg-white font-bold border-l-gray-800 shadow-md shadow-black"
          onClick={() => connect()}
        >
